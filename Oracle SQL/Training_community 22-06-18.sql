...
INSERT INTO MyUser VALUES(1, 'lee1545', '이순신', '22-05-04');
INSERT INTO MyUser VALUES(2, 'lee1502', '이황', '22-05-01');
INSERT INTO MyUser VALUES(3, 'lee1536', '이이', '22-05-02');
INSERT INTO MyUser VALUES(4, 'lee1397', '세종대왕', '22-05-03');
INSERT INTO MyUser VALUES(5, 'shin1504', '신사임당', '22-05-05');
...
INSERT INTO MyComment VALUES(1, 1, 2, '한산도 대첩(閑山島大捷) 혹은 견내량대첩(見乃梁大捷)은 1592년 8월 14일(선조 25년 음력 7월 8일) 통영 한산도 앞바다에서 조선 수군이 왜군을 크게 무찌른 해전', '22-05-01', NULL);
INSERT INTO MyComment VALUES(2, 1, 3, '이 전투에서 육전에서 사용하던 포위 섬멸 전술 형태인 학익진을 처음으로 해전에서 펼쳤다.', '22-05-01', 1);
INSERT INTO MyComment VALUES(3, 3, 2, '이이의 어머니 신사임당', '22-05-01', NULL);
INSERT INTO MyComment VALUES(4, 2, 1, '가나다라마바사', '22-05-01', NULL);
...
WHERE CONTENT LIKE '%신사임당%';

-- 9번 문제 답 
SELECT Category.NAME, POST.POST_SEQ, POST.TITLE, MyUser.USER_NAME, TO_CHAR(POST.DATETIME, 'YYYY/MM/DD') AS 날짜, count(*)
FROM POST 
